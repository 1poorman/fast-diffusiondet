...
# 数据集路径
DATASET_ROOT = 'E:\Files\DL code\datasets\wgisd'
ANN_ROOT = os.path.join(DATASET_ROOT, 'coco_annotations')
TRAIN_PATH = os.path.join(DATASET_ROOT, 'data')
VAL_PATH = os.path.join(DATASET_ROOT, 'data')
TRAIN_JSON = os.path.join(ANN_ROOT, 'train_bbox_instances.json')
VAL_JSON = os.path.join(ANN_ROOT, 'test_bbox_instances.json')
...
PREDEFINED_SPLITS_DATASET = {
    "wgisd_train": (TRAIN_PATH, TRAIN_JSON),
    "wgisd_val": (VAL_PATH, VAL_JSON),
}
